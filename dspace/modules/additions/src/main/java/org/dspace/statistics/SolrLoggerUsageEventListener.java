		...
		if(event instanceof UsageEvent)
		{
			try{
                ...
                if(UsageEvent.Action.SEARCH == ue.getAction()){
                    ...
                    if(!CollectionUtils.isEmpty(((UsageSearchEvent) ue).getQueries()) || !CollectionUtils.isEmpty(((UsageSearchEvent) ue).getFilterQueries())){
                        SolrLogger.postSearch(ue.getObject(), ue.getRequest(), currentUser,
                                usageSearchEvent.getQueries(), usageSearchEvent.getFilterQueries(),usageSearchEvent.getRpp(), usageSearchEvent.getSortBy(),
