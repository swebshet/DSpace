    ...
    <xsl:template name="buildFooter">
        <div id="ds-footer-wrapper">
            ...
            <div id="ds-footer-links">
                    ...
                    <xsl:text> | </xsl:text>
                    <a href="https://github.com/ilri/DSpace" target="_blank" title="CGSpace code on github">CGSpace @github</a>
                </div>
...
-->
    ...
    <xsl:template name="addJavascript">
        ...
        <script type="text/javascript" src="{concat($protocol, 'cdnjs.cloudflare.com/ajax/libs/jquery/', $jqueryVersion ,'/jquery.min.js')}">&#160;</script>
