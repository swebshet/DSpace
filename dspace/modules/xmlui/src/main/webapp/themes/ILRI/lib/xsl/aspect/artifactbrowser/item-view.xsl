...
<xsl:stylesheet
    ...
    <xsl:template name="itemSummaryView-DIM-fields">
      ...
      <xsl:choose>
		...
		<xsl:when test="$clause = 7 and (dim:field[@element='link' and @qualifier='audio'])">
                    <tr class="ds-table-row {$phase}">
   ...
   <!-- cg.link.citation row -->

		<xsl:when test="$clause = 8 and (dim:field[@element='link' and @qualifier='citation'])">
                    <tr class="ds-table-row {$phase}">
     ...
     <!-- cg.link.photo row -->
		...
		<xsl:when test="$clause = 9 and (dim:field[@element='link' and @qualifier='photo'])">
                    <tr class="ds-table-row {$phase}">
				...
				<hr class="metadata-seperator"/>
	                ...
	                <xsl:for-each select="dim:field[@element='link' and @qualifier='photo']">
		                <xsl:copy-of select="./node()"/>
		                <xsl:if test="count(following-sibling::dim:field[@element='identifier' and @qualifier='photo']) != 0">
				<hr class="metadata-seperator"/>
	                    </xsl:if>
			</xsl:for-each>
			<xsl:if test="count(dim:field[@element='link' and @qualifier='photo']) &gt; 1">
     ...
     <!-- cg.link.reference row -->

		<xsl:when test="$clause = 10 and (dim:field[@element='link' and @qualifier='reference'])">
                    <tr class="ds-table-row {$phase}">
		...
		<xsl:when test="$clause = 11 and (dim:field[@element='link' and @qualifier='video'])">
                    <tr class="ds-table-row {$phase}">
				...
				<hr class="metadata-seperator"/>
	                ...
	                <xsl:for-each select="dim:field[@element='link' and @qualifier='video']">
		                <xsl:copy-of select="./node()"/>
		                <xsl:if test="count(following-sibling::dim:field[@element='identifier' and @qualifier='video']) != 0">
				<hr class="metadata-seperator"/>
	                    </xsl:if>
			</xsl:for-each>
			<xsl:if test="count(dim:field[@element='link' and @qualifier='video']) &gt; 1">
           ...
           <!-- cg.livestock.agegroup row -->

		<xsl:when test="$clause = 12 and (dim:field[@element='livestock' and @qualifier='agegroup'])">
                    <tr class="ds-table-row {$phase}">
          ...
          <!-- cg.livestock.function row -->

		<xsl:when test="$clause = 13 and (dim:field[@element='livestock' and @qualifier='function'])">
                    <tr class="ds-table-row {$phase}">
       ...
       <!-- cg.message.sms row -->
		...
		<xsl:when test="$clause = 14 and (dim:field[@element='message' and @qualifier='sms'])">
                    <tr class="ds-table-row {$phase}">
				...
				<hr class="metadata-seperator"/>
	                ...
	                <xsl:for-each select="dim:field[@element='message' and @qualifier='sms']">
		                <xsl:copy-of select="./node()"/>
		                <xsl:if test="count(following-sibling::dim:field[@element='livestock' and @qualifier='sms']) != 0">
				<hr class="metadata-seperator"/>
	                    </xsl:if>
			</xsl:for-each>
			<xsl:if test="count(dim:field[@element='message' and @qualifier='sms']) &gt; 1">
        ...
        <!-- cg.message.voice row -->

		<xsl:when test="$clause = 15 and (dim:field[@element='message' and @qualifier='voice'])">
                    <tr class="ds-table-row {$phase}">
		...
		<xsl:when test="$clause = 16 and (dim:field[@element='relation' and @qualifier='ispartofseries'])">
                    <tr class="ds-table-row {$phase}">
          ...
          <!-- Abstract row -->
          <xsl:when test="$clause = 17 and (dim:field[@element='description' and @qualifier='abstract'])">
                    <tr class="ds-table-row {$phase}">
          ...
          <!-- identifier.uri row -->
          <xsl:when test="$clause = 19 and (dim:field[@element='identifier' and @qualifier='uri'])">
                    <tr class="ds-table-row {$phase}">
	...
	<!-- Type row -->
		 <xsl:when test="$clause = 20 and (dim:field[@element='type' and not(@qualifier)])">
                    <tr class="ds-table-row {$phase}">
		...
		<!-- Journal Title row -->
		   <xsl:when test="$clause = 21 and (dim:field[@element='title' and @qualifier='jtitle'])">
                    <tr class="ds-table-row {$phase}">
		 ...
		 <!-- Identifier URL row -->
		   <xsl:when test="$clause = 22 and (dim:field[@element='identifier' and @qualifier='url'])">
                    <tr class="ds-table-row {$phase}">
		    ...
		    <!-- Identifier DOI row -->
		   <xsl:when test="$clause = 23 and (dim:field[@element='identifier' and @qualifier='doi'])">
                    <tr class="ds-table-row {$phase}">
		  ...
		  <xsl:when test="$clause = 24 and (dim:field[@element='identifier' and @qualifier='dataurl'])">
                    <tr class="ds-table-row {$phase}">
		 ...
		 <!-- Status row -->
		<xsl:when test="$clause = 25 and (dim:field[@element='identifier' and @qualifier='status'])">
                    <tr class="ds-table-row {$phase}">
		...
		<!-- Google URL row -->
		<xsl:when test="$clause = 26 and (dim:field[@element='identifier' and @qualifier='googleurl'])">
                    <tr class="ds-table-row {$phase}">
		...
		<!-- River Basin row -->
            <xsl:when test="$clause = 27 and (dim:field[@element='river' and @qualifier='basin'])">
                    <tr class="ds-table-row {$phase}">
		...
		<xsl:when test="$clause = 28 and (dim:field[@element='cplace' and @qualifier='country'])">
                    <tr class="ds-table-row {$phase}">
         ...
         <!-- Region Focus row -->
		<xsl:when test="$clause = 29 and (dim:field[@element='rplace' and @qualifier='region'])">
                    <tr class="ds-table-row {$phase}">
	...
	<!-- CRP Subject row -->
		<xsl:when test="$clause = 30 and (dim:field[@element='crsubject' and @qualifier='crpsubject'])">
                    <tr class="ds-table-row {$phase}">
  ...
  <!-- ILRI Subject row -->
		<xsl:when test="$clause = 31 and (dim:field[@element='isubject' and @qualifier='ilrisubject'])">
                    <tr class="ds-table-row {$phase}">
	  ...
	  <!--  PROJECT SPONSOR row -->
		  <xsl:when test="$clause = 32 and (dim:field[@element='description' and @qualifier='sponsorship'])">
                    <tr class="ds-table-row {$phase}">
		...
		<!-- Fund row -->
		<xsl:when test="$clause = 33 and (dim:field[@element='identifier' and @qualifier='fund'])">
                    <tr class="ds-table-row {$phase}">
	     ...
	     <!-- ISI Journal -->
		  <xsl:when test="$clause = 34 and (dim:field[@element='isijournal' and not(@qualifier)])">
                    <tr class="ds-table-row {$phase}">
		 ...
		 <!-- ANIMAL SPECIES -->
		<xsl:when test="$clause =35 and (dim:field[@element='species' and @qualifier='animal'])">
                    <tr class="ds-table-row {$phase}">
